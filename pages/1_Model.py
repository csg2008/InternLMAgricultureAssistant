...
embedding_path = st.text_input('embedding 路径', value=st.session_state['model']['embedding_path'], max_chars=None, key=None, type='default', placeholder = '请输入 embedding 模型路径')
reranker_path = st.text_input('reranker 路径', value=st.session_state['model']['reranker_path'], max_chars=None, key=None, type='default', placeholder = '请输入 reranker 模型路径')
...
if saved:
    ...
    st.session_state['model']['reranker_path'] = reranker_path
