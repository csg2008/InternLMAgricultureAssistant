...
### F、微信个人助手测试
1、安装微信 8.0.47 版本与茴香豆个人助手

微信 8.0.47 版本可以在搜索引擎中找到后安装，茴香豆个人助手安卓版可以通过 [链接](https://github.com/InternLM/HuixiangDou/releases/tag/v0.1.0rc1) 下载安装
> 说明：当前演示设备为鸿蒙平板，不同操作系统的操作流程可能不通用

2、获取回调地址

进入 openXLab 平台茴香豆应用，点 `零开发集成微信` 下方的 `查看教程` 按钮，在弹窗中会显示回调地址。单击回调地址右边的按钮，可以将回调地址复制到剪贴板，再发送到微信。
![](./asset/64.png)

3、配置茴香豆个人助手

在设备上打开茴香豆个人助手，将上面的回调地址粘贴到应用界面中间的框中，再点确定保存
![](./asset/65.jpg)

4、配置辅助应用

在茴香豆个人助手界面点 `点我` 按钮，会自动导航到辅助应用配置界面，选择茴香豆个人助手后会出现以下确认提示，点确定即可
![](./asset/66.jpg)

5、茴香豆个人助手演示

切换回微信，用另一个微信账号向当前微信账号发送信息，就可以看到茴香豆个人助手自动回复了
![](./asset/67.jpg)

6、使用体会与遇到的问题

借助茴香豆个人助手的自动回复功能可以很方便的解决问答场景中大量相似问题的重复回复，还可以配置正反例问题让茴香豆回复的更专业，给用户更好的体验。

遇到的问题：
> - 重复回复：如果遇到不能回复的问题，会一直重复回复 `query is not a question 非常感谢您的提问...`，把茴香豆助手重启还是继续回复不能停止
